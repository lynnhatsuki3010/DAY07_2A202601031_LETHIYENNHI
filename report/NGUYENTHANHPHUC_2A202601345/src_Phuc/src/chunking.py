...
class SentenceChunker:
    ...
    # def chunk(self, text: str) -> list[str]:
    #     # [DONE]: split into sentences, group into chunks
    #     raise NotImplementedError("Implement SentenceChunker.chunk")
    def chunk(self, text: str) -> list[str]:
        if not text.strip():
            return []

        # Tách câu nhưng vẫn giữ lại dấu kết thúc câu
...
class RecursiveChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        # [DONE]: implement recursive splitting strategy
        if not text.strip():
            return []
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        # [DONE]: recursive helper used by RecursiveChunker.chunk
...
def compute_similarity(vec_a: list[float], vec_b: list[float]) -> float:
    ...
    """
    # [DONE]: implement cosine similarity formula
...
class ChunkingStrategyComparator:
    ...
    def compare(self, text: str, chunk_size: int = 200) -> dict:
        # [DONE]: call each chunker, compute stats, return comparison dict
        strategies = {
