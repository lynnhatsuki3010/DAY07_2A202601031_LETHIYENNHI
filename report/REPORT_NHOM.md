...
| Phạm Khánh Linh | Sentence (4 câu/chunk) | 5 | Q1 đạt tuyệt đối sau khi sửa lỗi trích xuất; retrieval tìm đúng chunk khá tốt (Q2 rank-2, Q4 rank-1) | Q3 miss hẳn (chunk dạng bảng "Policy / Borrowed items..." không khớp cụm từ chấm điểm dù đúng nội dung); Q4/Q5 đúng chunk nhưng không đạt rank-1 hoặc answer chưa đủ |
| Nguyễn Thanh Phúc | FixedSize (400/80) | 5 | Q3 đạt tuyệt đối sau khi sửa lỗi trích xuất; baseline ổn định | Cắt cứng ký tự làm chunk bắt đầu giữa từ ("olling from...", "rary card...", "ersity residing...") — dễ mất ngữ cảnh đầu chunk dù nội dung sau đó vẫn đúng |
| Vũ Huy Hoàng | HeadingSectionChunker (custom) | **7** | Q3/Q5 tuyệt đối; giữ trọn 1 Article/section = dễ truy vết nguồn; Q1/Q2 nay đã tìm đúng chunk (rank-1) sau khi sửa câu hỏi + lỗi trích xuất | Q1/Q2/Q4 dừng ở 1đ vì agent answer đúng nhưng chưa đủ chi tiết trong 2 câu đầu trích xuất; tài liệu staff (`k3-library-management-regulation`) đứng hạng 2 nếu KHÔNG lọc metadata — rủi ro rò rỉ audience cao nhất trong 5 chiến lược |
| Nguyễn Văn Phong | ClauseChunker (custom) | 6 | Q3/Q5 tuyệt đối; granularity mịn giúp câu trả lời phí/mức phạt chính xác từng điều khoản | Q1 vẫn miss hoàn toàn (rơi vào chunk "Note: Credits are understood as subjects..." bên tài liệu học phí — trùng từ khóa "credit" nhưng sai ngữ cảnh, kể cả sau khi viết lại câu hỏi rõ nghĩa hơn) |

**Chiến lược nào tốt nhất cho chủ đề này? Tại sao?**
> **Recursive (Nhi, 8/10)** rõ ràng tốt nhất trong nhóm — đạt tuyệt đối 4/5 câu, chỉ thua đúng 1 câu (Q2). Lý do: chunk theo ranh giới đoạn văn tự nhiên (`\n\n`/`\n`) vừa giữ trọn ngữ nghĩa một ý/điều khoản, vừa không cần regex tinh chỉnh riêng cho từng định dạng tài liệu như Heading (7/10, đứng nhì) hay Clause (6/10) — hai chiến lược custom này phụ thuộc format nguồn cụ thể (Article/heading La Mã hay clause "N.N"), dễ vỡ khi nhóm thêm tài liệu có cấu trúc khác. Recursive cũng an toàn nhất về audience: tài liệu staff không hề lọt top-8 kể cả khi bỏ metadata filter, trong khi Heading khiến nó lên hạng 2/8. Sentence và FixedSize (5/10) đều có retrieval không tệ (chunk đúng thường nằm ở rank 2-3) nhưng thua vì không đạt rank-1 hoặc câu trả lời bị cắt ở ranh giới ký tự/table — cho thấy đúng nội dung chunk thôi chưa đủ, thứ hạng rank-1 mới quyết định điểm tối đa.
...
|---|---------|-------------------------------|-------------------------------|---------|
| 1 | Credit = 50 hours | Recursive (Nhi, 2đ) | Recursive/Sentence/Heading: có (rank-1); Fixed: có (rank-1 nhưng answer thiếu); Clause: **không** | Sau khi viết lại câu hỏi rõ nghĩa hơn ("definition... in terms of study hours"), 4/5 chiến lược tìm đúng chunk — chỉ Clause vẫn miss vì mảnh clause quá nhỏ, mất ngữ cảnh câu định nghĩa |
| 2 | Đóng học phí 2 lần/năm | Heading (Hoàng, 1đ — chưa chiến lược nào đạt 2đ) | Recursive: không; Sentence: có (rank-2); Fixed: không; Heading: có (rank-1, answer đủ nhưng thiếu số "twice"); Clause: có (rank-3) | Câu khó nhất còn lại — câu trả lời hay lẫn với thông tin số tiền/chiết khấu học phí thay vì tần suất đóng; đã thử 8 cách diễn đạt lại câu hỏi, không cải thiện thêm được mà không lộ đáp án |
| 3 | Mượn tối đa 3 tài liệu/2 tuần | Recursive, Heading, Clause (cả 3 đạt 2đ) | Có ở 4/5 chiến lược (Sentence miss vì chunk dạng bảng không khớp cụm từ chấm) | Câu dễ nhất — câu trả lời nằm trọn 1 câu duy nhất trong nguồn |
| 4 | Năm nhất bắt buộc ở KTX | Recursive (Nhi, 2đ) | Có ở cả 5 chiến lược | Heading/Clause/Sentence tìm đúng chunk nhưng không ở rank-1 hoặc answer 2-câu-đầu chưa đủ chi tiết (xem Phần 4) |
...
> Có, rõ nhất ở Câu 3. Kiểm tra riêng: nếu **bỏ filter**, tài liệu `k3-library-management-regulation` (audience=staff) đứng **hạng 2/8** trong kết quả không lọc của chiến lược Heading (Hoàng) — chỉ đứng sau đúng 1 bậc so với chunk trả lời đúng, và hạng 4-5/8 ở Sentence/FixedSize. Với Recursive và Clause, tài liệu staff này không lọt top-8 nên filter ít ảnh hưởng hơn. Kết luận: mức độ cần filter phụ thuộc vào chiến lược chunking — chunk theo heading dễ làm tài liệu sai audience "trồi" lên gần top-k hơn vì mỗi chunk bao trọn ngữ cảnh chủ đề "thư viện" nói chung, kể cả với tài liệu dành cho staff.
...
> 1. Sau khi sửa lỗi generation và tinh chỉnh 1 câu hỏi, điểm cải thiện rõ rệt (Nhi 6→8, Hoàng 6→7, Linh/Phúc 4→5) mà **không đổi corpus hay chunking** — cho thấy retrieval quality không chỉ phụ thuộc chunking, mà cả cách đặt câu hỏi và cách trích xuất câu trả lời đều ảnh hưởng ngang hàng.
> 2. **Recursive (Nhi) vươn lên dẫn đầu rõ rệt (8/10)** sau khi loại bỏ nhiễu do lỗi generation — chunk theo đoạn văn tự nhiên vừa giữ trọn ngữ nghĩa vừa không phụ thuộc format nguồn cụ thể như 2 chiến lược custom.
...
> 4. Không phải mọi lỗi đều sửa được bằng cách viết lại câu hỏi — Câu 1 cải thiện được (nhập nhằng do diễn đạt), Câu 2 thì không (nhiễu do bản chất dữ liệu tài chính dày số liệu) — biết phân biệt 2 loại lỗi này quan trọng hơn là cố sửa bằng mọi giá.

**Bài học rút ra khi so sánh trong nhóm:**
> Cùng một bộ 7 tài liệu, cùng 5 câu hỏi, nhưng điểm dao động 5-8/10 chỉ do cách chia chunk khác nhau — cho thấy chunking ảnh hưởng trực tiếp đến việc model có "nhìn thấy" câu trả lời hay không. Sau khi sửa lỗi generation, khoảng cách giữa các chiến lược lộ rõ hơn (8 vs 5) thay vì bị lỗi hệ thống che lấp (trước đó 3 chiến lược hoà 6/10 một phần vì cùng bị lỗi cắt cụt).
...
| Chất lượng truy xuất (Retrieval Quality) | 8 / 10 *(điểm thật, chiến lược tốt nhất — Recursive — đạt 8/10 trên 5 câu benchmark; không làm tròn lên 10 vì Câu 2 thật sự chưa giải quyết được sau nhiều lần thử, xem Phần 4)* |
